...
- [`scripts/submission/README.md`](scripts/submission/README.md): exact
  execution order.
- [`writing/first_draft_feedback.tex`](writing/first_draft_feedback.tex):
...
writing/                Dissertation source and bibliography
```
...
The fast verification command checks all reported numerical claims against
the authoritative CSV summaries, resolves manuscript citations and labels,
confirms the required figures exist, and parses every active R source file:
